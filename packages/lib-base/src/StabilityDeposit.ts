...
export class StabilityDeposit {
  /** Amount of aUSD in the Stability Deposit at the time of the last direct modification. */
  readonly initialLUSD: Decimal;

  /** Amount of aUSD left in the Stability Deposit. */
  readonly currentLUSD: Decimal;

  /** Amount of native currency (e.g. Ether) received in exchange for the used-up aUSD. */
  readonly collateralGain: Decimal;

  /** Amount of AQU rewarded since the last modification of the Stability Deposit. */
   ...
   *
   * @returns The new deposited aUSD amount.
   */
