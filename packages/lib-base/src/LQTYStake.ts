...
/**
 * Represents the change between two states of an AQU Stake.
 *
 * @public
 */
...
/** 
 * Represents a user's AQU stake and accrued gains.
 * 
 * @remarks
...
export class LQTYStake {
  /** The amount of AQU that's staked. */
   ...
   *
   * @returns The new staked AQU amount.
   */
