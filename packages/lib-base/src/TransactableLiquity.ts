...
export interface TroveCreationDetails {
  ...
  /** Amount of aUSD added to the Trove's debt as borrowing fee. */
  fee: Decimal;
}
...
export interface LiquidationDetails {
  ...
  /** Amount of aUSD paid to the liquidator as gas compensation. */
...
export interface RedemptionDetails {
  /** Amount of aUSD the redeemer tried to redeem. */
  attemptedLUSDAmount: Decimal;

  /**
   * Amount of aUSD that was actually redeemed by the transaction.
   *
   * @remarks
...
export interface StabilityPoolGainsWithdrawalDetails {
  /** Amount of aUSD burned from the deposit by liquidations since the last modification. */
  lusdLoss: Decimal;

  /** Amount of aUSD in the deposit directly after this transaction. */
  newLUSDDeposit: Decimal;

  /** Amount of native currency (e.g. Ether) paid out to the depositor in this transaction. */
  collateralGain: Decimal;

  /** Amount of AQU rewarded to the depositor in this transaction. */
  lqtyReward: Decimal;
}

/**
 * Details of a
 * {@link TransactableLiquity.depositLUSDInStabilityPool | depositInStabilityPool()} or
...
/**
 * Send Aquarius transactions and wait for them to succeed.
 *
 * @remarks
...
export interface TransactableLiquity {
  /**
   * Open a new Trove by depositing collateral and borrowing aUSD.
   *
  ...
  /**
   * Adjust existing Trove by borrowing more aUSD.
   *
   * @param amount - The amount of aUSD to borrow.
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @liquity/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   *
   * @param amount - The amount of aUSD to repay.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @param amount - Amount of aUSD to add to new or existing deposit.
  ...
  /**
   * Withdraw aUSD from Stability Deposit.
   *
   * @param amount - Amount of aUSD to withdraw.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
  ...
  /**
   * Send aUSD tokens to an address.
   *
   * @param toAddress - Address of receipient.
   * @param amount - Amount of aUSD to send.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Redeem aUSD to native currency (e.g. Ether) at face value.
   *
   * @param amount - Amount of aUSD to be redeemed.
  ...
  /**
   * Allow the liquidity mining contract to use Uniswap FTM/aUSD LP tokens for
  ...
  /**
   * Register current wallet address as a Aquarius frontend.
   *
