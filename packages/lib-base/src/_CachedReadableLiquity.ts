...
export class _CachedReadableLiquity<T extends unknown[]>
  ...
  async getLqtyLpTokenBalance(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getLqtyLpTokenBalance(address, ...extraParams) ??
      this._readable.getLqtyLpTokenBalance(address, ...extraParams)
    );
  }
  ...
  async getRemainingLiquidityMiningLQTYOReward(...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getRemainingLiquidityMiningLQTYOReward(...extraParams) ??
      this._readable.getRemainingLiquidityMiningLQTYOReward(...extraParams)
    );
  }
  ...
  async getLiquidityMiningStakeLqtyLp(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
  ...
  async getTotalStakedLqtyLpTokens(...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getTotalStakedLqtyLpTokens(...extraParams) ??
      this._readable.getTotalStakedLqtyLpTokens(...extraParams)
    );
  }
  ...
  async getLiquidityMiningLQTYLpReward(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
