...
export class Fees {
   ...
   * the `when` parameter.
   *
   * To calculate the borrowing fee in aUSD, multiply the borrowed aUSD amount by the borrowing rate.
   *
   * @example
   * ```typescript
   ...
   *
   * @param redeemedFractionOfSupply - The amount of aUSD being redeemed divided by the total supply.
   ...
   * precise, it depends on the fraction of the redeemed amount compared to the total aUSD supply,
   * which must be passed as a parameter.
   *
   * To calculate the redemption fee in aUSD, multiply the redeemed aUSD amount with the redemption
   * rate.
   *
   * @example
   * ```typescript
