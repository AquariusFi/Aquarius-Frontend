 ...
 *     <td> borrowLUSD </td>
 *     <td> T </td>
 *     <td> The amount of aUSD that's borrowed. </td>
 *   </tr>
 *
 * </table>
 *
 ...
 *     <td> repayLUSD? </td>
 *     <td> T </td>
 *     <td> <i>(Optional)</i> The amount of aUSD that's repaid. </td>
 *   </tr>
 *
 * </table>
 *
 ...
 *     <td> borrowLUSD? </td>
 *     <td> T </td>
 *     <td> <i>(Optional)</i> The amount of aUSD that's borrowed. </td>
 *   </tr>
 *
 *   <tr>
 *     <td> repayLUSD? </td>
...
export class Trove {
  ...
  /**
   * Amount of aUSD that must be repaid to close this Trove.
   *
   * @remarks
   ...
   *
   * @example
   * Can be used to check whether the Aquarius protocol is in recovery mode by using it on the return
