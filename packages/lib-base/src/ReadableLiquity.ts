...
/**
 * Represents whether an address has been registered as a Aquarius frontend.
 *
 * @remarks
...
export interface ReadableLiquity {
  ...
  /**
   * Get the total amount of collateral and debt in the Aquarius system.
   */
  ...
  /**
   * Get the remaining AQU that will be collectively rewarded to stability depositors.
   */
  getRemainingStabilityPoolLQTYReward(): Promise<Decimal>;

  /**
   * Get the total amount of aUSD currently deposited in the Stability Pool.
   */
  getLUSDInStabilityPool(): Promise<Decimal>;

  /**
   * Get the amount of aUSD held by an address.
   *
  ...
  /**
   * Get the amount of AQU held by an address.
   *
   * @param address - Address whose balance should be retrieved.
   */
  ...
  /**
   * Get the current state of an AQU Stake.
   *
   * @param address - Address that owns the AQU Stake.
   */
  getLQTYStake(address?: string): Promise<LQTYStake>;

  /**
   * Get the total amount of AQU currently staked.
   */
  getTotalStakedLQTY(): Promise<Decimal>;

  /**
   * Check whether an address is registered as a Aquarius frontend, and what its kickback rate is.
   *
