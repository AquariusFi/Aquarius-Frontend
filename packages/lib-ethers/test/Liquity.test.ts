...
describe("EthersLiquity", () => {
  ...
  describe("StabilityPool", () => {
    ...
    describe("when people overstay", () => {
      before(async () => {
        ...
        // Use this account to print aUSD
  ...
  describe("Redemption", () => {
    ...
    it("should redeem some aUSD after the bootstrap phase", async () => {
  ...
  describe("Liquidity mining", () => {
    ...
    it("should obtain some CAKE LP tokens", async () => {
    ...
    it("should fail to stake CAKE LP before approving the spend", async () => {
      await expect(liquity.stakeUniTokens(someUniTokens)).to.eventually.be.rejected;
    });

    it("should stake CAKE LP after approving the spend", async () => {
