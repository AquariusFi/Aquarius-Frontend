...
const uniLink = (lusdAddress: string) =>
  `https://app.sushi.com/swap?inputCurrency=${lusdAddress}&outputCurrency=FTM`;
        ...
        <Card>
          <Box sx={{ p: [2, 3] }}>
            <InfoMessage title="Bot functionality">
              ...
              <Paragraph sx={{ mt: 2 }}>
                Most of the time you will get a better rate for converting aUSD to FTM on{" "}
                <Link href={uniLink(addresses["lusdToken"])} target="_blank">
                Fantom <Icon name="external-link-alt" size="xs" />
                </Link>{" "}
                or other exchanges.
              </Paragraph>
              <Paragraph sx={{ mt: 2 }}>
