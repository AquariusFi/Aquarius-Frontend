...
const UnsupportedMainnetFallback: React.FC = () => (
  ...
  >
    ...
    <Paragraph sx={{ mb: 3 }}>
      Please change your network to Fantom Chain.
    </Paragraph>

    <Paragraph>
      If you'd like to use the Aquarius Protocol on mainnet, please pick a frontend{" "}
...
const App = () => {
  ...
  const unsupportedNetworkFallback = (chainId: number) => (
    ...
    >
      <Heading sx={{ mb: 3 }}>
        <Icon name="exclamation-triangle" /> Aquarius is not yet deployed to{" "}
