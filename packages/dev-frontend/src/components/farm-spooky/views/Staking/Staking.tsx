...
const selector = ({ totalStakedAusdLpTokens }: LiquityStoreState) => ({ totalStakedAusdLpTokens });

export const Staking: React.FC = () => {
  const { dispatchEvent } = useFarmViewLp();
  const { totalStakedAusdLpTokens } = useLiquitySelector(selector);
  ...
  const nextTotalStakedUniTokens = totalStakedAusdLpTokens.add(amount);
