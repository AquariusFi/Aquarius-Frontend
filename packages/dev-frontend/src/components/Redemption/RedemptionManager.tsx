...
export const RedemptionManager: React.FC = () => {
  ...
  const [canRedeem, description] = total.collateralRatioIsBelowMinimum(price)
    ? [
        false,
        <ErrorDescription>
          You can't redeem aUSD when the total collateral ratio is less than{" "}
    ...
    : [
        true,
        <ActionDescription>
          You will receive <Amount>{ethAmount.sub(ethFee).prettify(4)} FTM</Amount> in exchange for{" "}
          <Amount>
            ...
            <InfoIcon
              tooltip={
                <Card variant="tooltip" sx={{ minWidth: "240px" }}>
                  ...
                  Fee depends on aUSD redemption volumes and is 0.5% at minimum.
                </Card>
              }
            />
          }
