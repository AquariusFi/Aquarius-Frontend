...
Can be used to check whether the Aquarius protocol is in recovery mode by using it on the return value of [getTotal()](./lib-base.readableliquity.gettotal.md)<!-- -->. For example:
