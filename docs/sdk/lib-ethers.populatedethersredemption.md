...
The Aquarius protocol fulfills redemptions by repaying the debt of Troves in ascending order of their collateralization ratio, and taking a portion of their collateral in exchange. Due to the [minimum debt](./lib-base.lusd_minimum_debt.md) requirement that Troves must fulfill, some aUSD amounts are not possible to redeem exactly.
...
|  --- | --- | --- | --- |
|  [attemptedLUSDAmount](./lib-ethers.populatedethersredemption.attemptedlusdamount.md) |  | [Decimal](./lib-base.decimal.md) | Amount of aUSD the redeemer is trying to redeem. |
...
|  [redeemableLUSDAmount](./lib-ethers.populatedethersredemption.redeemablelusdamount.md) |  | [Decimal](./lib-base.decimal.md) | Maximum amount of aUSD that is currently redeemable from <code>attemptedLUSDAmount</code>. |
